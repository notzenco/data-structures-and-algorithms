...
| Data Structure | C | C++ | C# | Elixir | Go | Haskell | Java | Kotlin | PHP | Python | Ruby | Rust | Scala | Swift | TypeScript |
|----------------|---|-----|----|----|-------|---------|------|--------|-----|--------|------|------|-------|-------|------------|
...
| Algorithm | C | C++ | C# | Elixir | Go | Haskell | Java | Kotlin | PHP | Python | Ruby | Rust | Scala | Swift | TypeScript |
|-----------|---|-----|----|----|-------|---------|------|--------|-----|--------|------|------|-------|-------|------------|
