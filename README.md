...
| Data Structure | C | C++ | C# | Go | Java | Kotlin | PHP | Python | Ruby | Rust | Scala | Swift | TypeScript |
|----------------|---|-----|----|----|------|--------|-----|--------|------|------|-------|-------|------------|
...
| Algorithm | C | C++ | C# | Go | Java | Kotlin | PHP | Python | Ruby | Rust | Scala | Swift | TypeScript |
|-----------|---|-----|----|----|------|--------|-----|--------|------|------|-------|-------|------------|
