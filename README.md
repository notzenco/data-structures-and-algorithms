...
| Data Structure | C | C++ | C# | Elixir | Go | Haskell | Java | Julia | Kotlin | Lua | Nim | PHP | Python | Ruby | Rust | Scala | Swift | TypeScript | Zig |
|----------------|---|-----|----|----|-------|---------|------|-------|--------|-----|-----|-----|--------|------|------|-------|-------|------------|-----|
...
| Algorithm | C | C++ | C# | Elixir | Go | Haskell | Java | Julia | Kotlin | Lua | Nim | PHP | Python | Ruby | Rust | Scala | Swift | TypeScript | Zig |
|-----------|---|-----|----|----|-------|---------|------|-------|--------|-----|-----|-----|--------|------|------|-------|-------|------------|-----|
