...
| Data Structure | C | C++ | C# | Go | Haskell | Java | Kotlin | PHP | Python | Ruby | Rust | Scala | Swift | TypeScript |
|----------------|---|-----|----|----|---------|------|--------|-----|--------|------|------|-------|-------|------------|
...
| Algorithm | C | C++ | C# | Go | Haskell | Java | Kotlin | PHP | Python | Ruby | Rust | Scala | Swift | TypeScript |
|-----------|---|-----|----|----|---------|------|--------|-----|--------|------|------|-------|-------|------------|
